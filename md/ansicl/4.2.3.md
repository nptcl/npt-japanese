...
`array`                 |[`member`](4.4.member-type.html)       |`simple-bit-vector`   |
[`base-string`](16.2.base-string.html)           |`mod`          |[`simple-string`](16.2.simple-string.html)       |
`bit-vector`            |[`not`](4.4.not-type.html)          |`simple-vector`       |
...
|                            |                         |                            |
|----------------------------|-------------------------|----------------------------|
|[`and`](4.4.and-type.html)             |[`function`](4.4.function-system-class.html) |`simple-array`     |
...
|`bit-vector`           |[`member`](4.4.member-type.html)       |[`simple-warning`](9.2.simple-warning.html)       |
...
|[`cons`](14.2.cons-system-class.html)    |`package-error`     |[`string`](16.2.string-system-class.html)  |
